  ...
  return (
    <header className="mt-4 px-8 lg:px-16 py-5 flex items-center shadow-md bg-white/30 dark:bg-gray-900/30 backdrop-blur-lg mx-auto max-w-screen-xl w-full">
      ...
      <nav className="ml-auto flex gap-8">
        ...
        <Link className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:underline underline-offset-4" href="#">Features</Link>
        <Link className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:underline underline-offset-4" href="#">About</Link>
        <Link className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:underline underline-offset-4" href="#">Contact</Link>
      </nav>
    </header>
  );
}
